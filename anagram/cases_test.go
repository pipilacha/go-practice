...
var testCases = []anagramTest{
	...
	{
		description: "does not detect non-anagrams with identical checksum and same max and min rune",
		subject:     fmt.Sprintf("%c%c%c%c", rune(15), rune(5), rune(5), rune(3)),
		candidates: []string{
			fmt.Sprintf("%c%c%c%c", rune(15), rune(5), rune(5), rune(3)),
			fmt.Sprintf("%c%c%c%c", rune(15), rune(7), rune(3), rune(3)),
			fmt.Sprintf("%c%c%c%c", rune(15), rune(3), rune(3), rune(7)),
			fmt.Sprintf("%c%c%c%c", rune(3), rune(5), rune(15), rune(5)),
		},
		expected: []string{fmt.Sprintf("%c%c%c%c", rune(3), rune(5), rune(15), rune(5))},
	},
}
